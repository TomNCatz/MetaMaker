...
namespace MetaMaker
{
    public partial class SettingsPopup : ConfirmationDialog
    {
		...
		public override void _Ready()
        {
			...
			_backColorRect.Connect("gui_input",new Callable(this,nameof(GetBackgroundColor)));
			_majorColorRect.Connect("gui_input",new Callable(this,nameof(GetMajorColor)));
			_minorColorRect.Connect("gui_input",new Callable(this,nameof(GetMinorColor)));
